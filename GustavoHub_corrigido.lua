...
UserInputService.InputBegan:Connect(
    function(Input, GameProcessed)
        --------------------------------------------------
        -- KEYBIND CAPTURE MUST RUN BEFORE GameProcessed
        --------------------------------------------------

        if ChangingAimKey then
            if IsMouseButton(Input.UserInputType) then
                AimKey = Input.UserInputType
                AimKeyButton.Text = "AIM KEY: " .. GetInputName(Input.UserInputType)
                ChangingAimKey = false
                return
            end
            ...
            if Input.KeyCode ~= Enum.KeyCode.Unknown then
                ...
                AimKeyButton.Text = "AIM KEY: " .. GetInputName(nil, Input.KeyCode)
                ChangingAimKey = false
                return
            end
        end
        ...
        if ChangingAimToggleKey then
            if Input.KeyCode == Enum.KeyCode.Backspace
                ...
                AimToggleKey = nil
                AimToggleKeyButton.Text = "AIM-LOCK TOGGLE: NONE"
                ChangingAimToggleKey = false
                return
            end
            ...
            if IsMouseButton(Input.UserInputType) then
                ...
                AimToggleKeyButton.Text = "AIM-LOCK TOGGLE: " .. GetInputName(Input.UserInputType)
                ChangingAimToggleKey = false
                return
            end
            ...
            if Input.KeyCode ~= Enum.KeyCode.Unknown then
                ...
                AimToggleKeyButton.Text = "AIM-LOCK TOGGLE: " .. GetInputName(nil, Input.KeyCode)
                ChangingAimToggleKey = false
                return
            end
        end
        ...
        if ChangingESPToggleKey then
            if Input.KeyCode == Enum.KeyCode.Backspace
                or Input.KeyCode == Enum.KeyCode.Delete then
                ESPToggleKey = nil
                ESPToggleKeyButton.Text = "ESP TOGGLE: NONE"
                ChangingESPToggleKey = false
                return
            end
            ...
            if IsMouseButton(Input.UserInputType) then
                ...
                ESPToggleKeyButton.Text = "ESP TOGGLE: " .. GetInputName(Input.UserInputType)
                ChangingESPToggleKey = false
                return
            end
            ...
            if Input.KeyCode ~= Enum.KeyCode.Unknown then
                ...
                ESPToggleKeyButton.Text = "ESP TOGGLE: " .. GetInputName(nil, Input.KeyCode)
                ChangingESPToggleKey = false
                return
            end
        end

        -- GUI/Minimize keybinds are keyboard-only and retain their old behavior.
        ...
        -- Do not let normal gameplay hotkeys react to UI input.
        ...
        local IsAimToggleInput = AimToggleKey ~= nil and (
        ...
        local IsESPToggleInput = ESPToggleKey ~= nil and (
