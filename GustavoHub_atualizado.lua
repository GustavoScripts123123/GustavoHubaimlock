    ...
    function(Input, GameProcessed)
        ...
        if ChangingAimKey then
            ...
            if mouseButton then
                ...
                AimKeyButton.Text =
                    "AIM KEY: " .. (Names[inputType] or inputType.Name)
        ...
        if ChangingAimToggleKey then
            if Input.UserInputType == Enum.UserInputType.MouseButton1
                ...
                AimToggleKeyButton.Text =
                    "AIM-LOCK TOGGLE: " .. Names[Input.UserInputType]
            ...
            if Input.KeyCode ~= Enum.KeyCode.Unknown then
                ...
                AimToggleKeyButton.Text =
                    "AIM-LOCK TOGGLE: " .. Input.KeyCode.Name
                ChangingAimToggleKey = false
            end
        ...
        if ChangingESPToggleKey then
            if Input.UserInputType == Enum.UserInputType.MouseButton1
                ...
                ESPToggleKeyButton.Text =
                    "ESP TOGGLE: " .. Names[Input.UserInputType]
...
UserInputService.InputEnded:Connect(
    function(Input)
        ...
        if IsAimInput then
            -- Ao largar o botão, perde o alvo.
            -- Ao pressionar novamente, procura outro.
            Aiming = false
            LockedTarget = nil
        end
    end
